...
COPY crashes
FROM
'/Users/saanilkhanna/Documents/Portfolio/SQL project 2/chicago_traffic_crashes_part_1.csv'
DELIMITER ',' CSV HEADER;

COPY crashes
FROM
'/Users/saanilkhanna/Documents/Portfolio/SQL project 2/chicago_traffic_crashes_part_2.csv'
DELIMITER ',' CSV HEADER;

COPY crashes
FROM
'/Users/saanilkhanna/Documents/Portfolio/SQL project 2/chicago_traffic_crashes_part_3.csv'
DELIMITER ',' CSV HEADER;
